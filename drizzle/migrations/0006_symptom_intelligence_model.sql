...
-- Note: initial 10-rule seed intentionally omitted on the Cloud cutover.
-- The full 32-rule live set is restored from supabase/backup/symptom_severity_rules.sql
...
-- 11. Severity rules read policy (from 20251214205839)
